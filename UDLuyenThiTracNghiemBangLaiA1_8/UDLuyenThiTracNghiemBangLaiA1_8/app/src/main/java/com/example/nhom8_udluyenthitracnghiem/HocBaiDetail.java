...
public class HocBaiDetail extends AppCompatActivity implements View.OnClickListener{
    ...
    private Question1 quesSelected;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_hoc_bai_detail);
        initWidget();
        try {
        ...
        switch (v.getId()){
            ...
            case R.id.learning_btnResult:
                ...
                for(int i:getQuesSelected().getResult()){
                    ...
                    view.setBackgroundResource(R.color.xanh);
                }
                break;
    ...
    private void initWidget(){
        this.listView_Nav = findViewById(R.id.layout_learning_lvdrawer);
        this.listView_Answer = findViewById(R.id.layout_learning_answer);
        this.description =  findViewById(R.id.learning_question);
        this.imgBack =findViewById(R.id.learning_btnBack);
        this.imgNext = findViewById(R.id.learning_btnNext);
        this.imgView = findViewById(R.id.learning_image_question);
    }
        ...
        listView_Nav.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                try {
                    ...
                    Toast.makeText(HocBaiDetail.this, e.toString(), Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                }
    ...
    private void createListViewAnswer(int index) throws Exception{
        ...
        Question1 question = getMyResource().getIndex(index);
    ...
    private void updateLayout(int index, String des){
        ...
        getSupportActionBar().setTitle("Câu "+(index+1));
        setDescription(des);
        loadImage(index);
    }
    ...
    public Question1 getQuesSelected() {
        return quesSelected;
    }

    public void setQuesSelected(Question1 quesSelected) {
