...
public class myResource {
    ...
    public Question1 getIndex(int index) throws Exception{
        ...
        question = new Question1(des,ans,rlt,path);
        return question;
    }

    // Lấy câu hỏi theo vị trí từ bao nhiêu cho tới bao nhiêu
    public ArrayList<Question1> getIndex(int begin, int end) throws Exception{
        ArrayList<Question1> arrayList=null;
